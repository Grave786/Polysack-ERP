 ...
 * PP Poly & Paper Products - Manufacturer of PP woven sack bags
 * 
 * Visual Theme:
...
export default function LandingPage() {
    ...
    return (
        <div className="min-h-screen bg-[#f8fafc] text-slate-800 font-sans selection:bg-[#f59e0b]/30 selection:text-[#b45309] overflow-x-hidden">
            ...
            <header className="sticky top-0 z-40 w-full backdrop-blur-md bg-white/95 border-b border-slate-200 transition-all shadow-xs">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-18 flex items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-white border border-slate-200/80 p-1 flex items-center justify-center shadow-xs shrink-0 overflow-hidden">
                            {!logoError ? (
                                <img
                                    src="/logo.png"
                                    alt="PP Poly & Paper Products"
                                    className="w-full h-full object-contain"
                                    onError={() => setLogoError(true)}
                                />
                            ) : (
                                <div className="w-full h-full rounded-lg bg-[#f59e0b]/15 border border-[#f59e0b]/30 flex items-center justify-center text-[#d97706] font-bold text-xs">
                        ...
                        <div className="flex flex-col justify-center">
                            <div className="flex items-center gap-2">
                                <span className="text-sm sm:text-base md:text-lg font-black tracking-tight text-slate-900 leading-none">
                                    PP Poly &amp; Paper Products
                                </span>
                                <span className="text-[10px] font-bold px-1.5 py-0.5 rounded bg-[#f59e0b]/15 text-[#b45309] border border-[#f59e0b]/30 leading-none shrink-0">
                                    ERP
                                </span>
                            </div>
                            <span className="text-[11px] text-slate-500 font-medium hidden xs:block tracking-wide mt-1">
                                Manufacturer of PP woven sack bags
                            </span>
                        </div>
                    </div>
            ...
            {/* CONTACT US SECTION                                                        */}
            {/* ========================================================================= */}
            <section id="contact" className="py-16 sm:py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 scroll-mt-20">
                <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-12 space-y-3">
                    <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-50 border border-amber-300 text-amber-800 text-xs font-semibold tracking-wide uppercase shadow-xs">
                        <Sparkles size={14} className="text-[#d97706]" />
                        <span>Direct Factory &amp; Sales Inquiries</span>
                    </div>
                    <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black text-slate-900 tracking-tight">
                        Contact Us
                    </h2>
                    <p className="text-sm sm:text-base text-slate-600 leading-relaxed">
                        Get in touch directly with our sales leadership for custom woven sack orders, technical GSM specifications, and factory visits.
                    </p>
                </div>

                <div className="rounded-3xl bg-white border border-slate-200 shadow-xl overflow-hidden">
                    <div className="grid grid-cols-1 lg:grid-cols-12 divide-y lg:divide-y-0 lg:divide-x divide-slate-200">
                        {/* Column 1: Contact Person & Sales Lead */}
                        <div className="lg:col-span-5 p-6 sm:p-10 bg-gradient-to-br from-amber-50/40 via-white to-slate-50/70 flex flex-col justify-between space-y-6">
                            <div className="space-y-6">
                                <div className="flex items-center gap-4">
                                    <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#f59e0b] to-[#d97706] text-slate-950 font-black text-xl shadow-md shadow-[#f59e0b]/25 flex items-center justify-center shrink-0">
                                        SK
                                    </div>
                                    <div>
                                        <div className="inline-block px-2.5 py-0.5 rounded-full text-[11px] font-bold bg-[#f59e0b]/15 text-[#b45309] border border-[#f59e0b]/30 mb-1">
                                            Sales Leadership
                                        </div>
                                ...
                                <div className="p-4 rounded-xl bg-white border border-slate-200/80 shadow-xs space-y-2">
                                    <div className="text-xs text-slate-700 leading-relaxed font-medium">
                                        <span className="font-bold text-slate-900 block text-sm">PP Poly &amp; Paper Products</span>
                                        <span className="text-slate-500 font-normal">Manufacturer of PP woven sack bags</span>
                                    </div>
                                    <p className="text-xs text-slate-600 leading-relaxed pt-2 border-t border-slate-100">
                                        Dedicated contact for bulk orders, customized bag sizes, packaging materials, and dispatch coordination.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="pt-2">
                                <a
                                    href="tel:+919996986764"
                                    className="w-full inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl text-sm font-bold text-slate-950 bg-[#f59e0b] hover:bg-[#d97706] transition-all shadow-sm shadow-[#f59e0b]/25 cursor-pointer"
                                >
                                    <Phone size={16} />
                                    <span>Call Sonu Kumar</span>
                                </a>
                            </div>
                        </div>

                        {/* Column 2: Phone, Alt Phone, Email, Address */}
                        <div className="lg:col-span-7 p-6 sm:p-10 space-y-4 sm:space-y-5 bg-white">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                {/* Primary Phone */}
                                <a
                                    href="tel:+919996986764"
                                    className="p-4 rounded-2xl border border-slate-200 bg-slate-50/60 hover:bg-amber-50/40 hover:border-amber-300/80 transition-all group block shadow-2xs"
                                >
                                    <div className="flex items-center gap-3 mb-2">
                                        <div className="w-9 h-9 rounded-xl bg-[#f59e0b]/15 border border-[#f59e0b]/30 flex items-center justify-center text-[#d97706] group-hover:scale-105 transition-transform shrink-0">
                                            <Phone size={18} />
                                        </div>
                                        <div>
                                    ...
                                    <div className="text-sm sm:text-base font-bold text-slate-900 group-hover:text-[#d97706] transition-colors">
                                        +91-9996986764
                                    </div>
                                </a>
                                ...
                                {/* Email Address */}
                                <a
                                    href="mailto:contact@pppolypaperproducts.in"
                                    className="p-4 rounded-2xl border border-slate-200 bg-slate-50/60 hover:bg-amber-50/40 hover:border-amber-300/80 transition-all group block shadow-2xs sm:col-span-2"
                                >
                                    <div className="flex items-center gap-3 mb-2">
                                        <div className="w-9 h-9 rounded-xl bg-[#f59e0b]/15 border border-[#f59e0b]/30 flex items-center justify-center text-[#d97706] group-hover:scale-105 transition-transform shrink-0">
                                            <Mail size={18} />
                                        ...
                                        <div>
                                            ...
                                            <span className="text-xs font-semibold text-slate-600">
                                                Direct Inquiries &amp; RFQs
                                            </span>
                                        </div>
                                    </div>
                                    <div className="text-sm sm:text-base font-bold text-slate-900 group-hover:text-[#d97706] transition-colors break-all">
                                        contact@pppolypaperproducts.in
                                    </div>
                                </a>

                                {/* Works & Plant Address */}
                                <div className="p-4 rounded-2xl border border-slate-200 bg-slate-50/60 shadow-2xs sm:col-span-2">
                                    <div className="flex items-start gap-3">
                                        <div className="w-9 h-9 rounded-xl bg-[#f59e0b]/15 border border-[#f59e0b]/30 flex items-center justify-center text-[#d97706] shrink-0 mt-0.5">
                                            <MapPin size={18} />
                                        </div>
                                        <div className="space-y-1">
                                            <span className="text-[11px] font-bold uppercase tracking-wider text-slate-400 block">
                                            ...
                                            <p className="text-sm font-bold text-slate-900 leading-relaxed">
                                                Plot No. 242, Ph-1, HSIIDC Rai, Dist. Sonipat, (Haryana) - 131029
                                            </p>
                                            <p className="text-xs text-slate-500 pt-0.5">
                                                HSIIDC Industrial Estate, Phase-1, Rai, District Sonipat, Haryana.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                        ...
                        <div className="md:col-span-2 space-y-3">
                            <div className="flex items-center gap-2.5">
                                <div className="w-14 h-14 rounded-lg bg-white border border-slate-200 p-0.5 flex items-center justify-center shadow-xs shrink-0 overflow-hidden">
                                    {!footerLogoError ? (
                                        <img
                                            src="/logo.png"
                                            alt="PP Poly & Paper Products"
                                        ...
                                        <div className="w-full h-full rounded bg-[#f59e0b]/15 flex items-center justify-center text-[#d97706]">
                                            <Package size={16} />
                                        </div>
                                    )}
                                </div>
                                <span className="text-lg font-black text-slate-900">PP Poly &amp; Paper Products</span>
                            </div>
                            <p className="text-xs text-slate-600 max-w-sm leading-relaxed">
                                Manufacturer of PP woven sack bags and enterprise resource planning system designed specifically for polypropylene (PP), HDPE, and paper woven sack manufacturing plants.
                            </p>
                        </div>
                    ...
                    <div className="pt-8 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500 text-center sm:text-left">
                        <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
                            <span>
                                © {new Date().getFullYear()} PP Poly &amp; Paper Products. All Rights Reserved.
                            </span>
